...
const firebaseConfig = {
    databaseURL: "https://taskmaster-86153-default-rtdb.asia-southeast1.firebasedatabase.app/"
};
...
addButtonEl.addEventListener("click", function () {
    const choreText = choreInputEl.value.trim();
    if (choreText !== "") {
        push(referenceInDB, choreText);
        choreInputEl.value = "";
    } else {
